...
*│◇-. INFO DEL BOT🎡*
*│◇-. 🧁Creador:* 𝐌𝐚𝐝𝐧ͩ𝐞ͫ𝐬ᷤ𝐬
*│◇-. 🧋Número:* +5493873084433
*│◇-. 🧁Prefijos:* * ${ usedPrefix } *
*│◇-. 🧋Chats Privados:* * ${ chats . grupos de longitud  . longitud }  *
*│◇-. 🧁Chats de Grupos:* * ${ grupos . longitud } *
*│◇-. 🧋Chats Totales:* * ${ chats . longitud } *
*│◇-. 🧁Actividad* * ${ tiempo de actividad } *
*│◇-. 🧋Usuarios* * ${ totalreg } 𝚗𝚞𝚖𝚎𝚛𝚘𝚜*
*│◇-. 🧁AutoRead:* ${ lectura automática ? '*Activado*' : '*Desactivado*' }
*│◇-. 🧋Restrict:* ${ restringir ? '*Activado*' : '*Desactivado*' } 
